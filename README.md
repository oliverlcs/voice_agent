...
pushes the first three into a running server, `uv run python demo/seed_history.py` adds a past
conversation and memories; `demo/background.md` has the facts that are not in
